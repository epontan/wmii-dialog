...
setup(void) {
    ...
    dw = w;
    dh = (vs*3) + ((dc.font.ascent + dc.font.descent) * num_lines);
    ...
    win = XCreateWindow(dpy, root, x, y, dw, dh, 1,
...
main(int argc, char *argv[]) {
    ...
    for(i = 1; i < argc; i++)
        if(!strcmp(argv[i], "-fn")) {
            ...
            eprint("wmii-dialog-"VERSION", Copyright 2015 Pontus Andersson\n");
